...
# http://stackoverflow.com/questions/21549847/send-key-combination-with-python
...
# Sending keystrokes copied from: http://stackoverflow.com/a/13615802/1226799
...
def alt_tab():
    '''
    Press Alt+Tab and hold Alt key for 1.5 seconds in order to see the overlay
    '''

    press_key(VK_ALT)
    tap_key(VK_TAB)

    # TODO start another thread
    time.sleep(1.5)
    release_key(VK_ALT)
